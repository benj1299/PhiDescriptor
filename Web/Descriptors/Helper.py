...
class Helper:
    ...
    def auto_remove_results(folder="./resultats"):
        ...
        for filename in os.listdir(folder):
            ...
            try:
                ...
                print('Problème de suppression %s. Raison: %s' % (file_path, e))
    ...
    def preprocessImages(images_path):
        ...
        for index, image in enumerate(images):
            ...
            cv2.imwrite(images_path+'/resultats/image_{}.png'.format(index), images[index])
    ...
    def convertImagesToObjects(images):
        return [Object(image) for image in images]